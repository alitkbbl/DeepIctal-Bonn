...
```
DeepIctal-Bonn/
├── data/raw/{Z,O,N,F,S}/          # Raw Bonn EEG recordings
├── figures/                       # Generated plots (300 DPI)
├── models/deepictal_lstm.keras    # Trained model checkpoint
├── reports/                       # results.json, report.tex, report.pdf
├── templates/                     # README / report templates
├── deepictal_bonn_pipeline.py     # Data + model pipeline
├── generate_docs.py               # Builds README + report from results
├── DeepIctal_Bonn.ipynb           # Notebook version of the pipeline
├── README.md
└── requirements.txt
```
...
---
<div align="center">
<sub>Generated by the DeepIctal-Bonn pipeline · seed 21 · 2026-08-30T16:45:13</sub>
</div>
